...
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/sam7oo/gindex2@latest/custom.css">');
// Markdown
...
function nav(path) {
    ...
    <a href="https://www.anshume.com" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'FWAPDeveloper'}">
...
document.write('<script src="//cdn.jsdelivr.net/gh/sam7oo/gindex2@latest/cari.js"></script>');
